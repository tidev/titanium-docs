---
title: Appcelerator CLI 6.0.0.GA - 14 November 2016
weight: '110'
---
...
* [CLI-1109](https://jira.appcelerator.org/browse/CLI-1109) - Integrate the new acs restart command into the APPC CLI
    ...
    * See [Command Line Interface Reference - restart](/guide/AMPLIFY_Runtime_Services/AMPLIFY_Runtime_Services_Guide/AMPLIFY_Runtime_Services_Command-Line_Interface_Reference/#LineInterfaceReference-restart) for more details
