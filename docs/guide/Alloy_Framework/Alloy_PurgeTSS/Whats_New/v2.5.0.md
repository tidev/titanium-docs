...
See the new feature in [What's New in v.2.5.3](/guide/Alloy_Framework/Alloy_PurgeTSS/Whats_New/v2.5.3.md#set-rotate-scale-and-anchorpoints-in-open-and-close-states)

### v2.5.5: New `draggable` method, modifiers and properties
See the new features in [What's New in v.2.5.5](/guide/Alloy_Framework/Alloy_PurgeTSS/Whats_New/v2.5.5.md#new-draggable-method-modifiers-and-properties-in-the-animation-module)
