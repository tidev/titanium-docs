...
**Up to 2.5 faster than [v 2.6.0](/guide/Alloy_Framework/Alloy_PurgeTSS/whats-new/v2.6.0.md#reduced-purge-time)!** On a project with more than 100 XML files, purging time was reduced from 350 ms down to 140 ms.
