...
| Collection.create (id == null)  <br />or  <br />Collection.create (id != null) | create  <br />or  <br />update | POST  <br />or  <br />PUT | INSERT  <br />or  <br />UPDATE |
| Model.fetch | read | GET | SELECT |
| Model.save (id == null)  <br />or  <br />Model.save (id != null) | create  <br />or  <br />update | POST  <br />or  <br />PUT | INSERT  <br />or  <br />UPDATE |
