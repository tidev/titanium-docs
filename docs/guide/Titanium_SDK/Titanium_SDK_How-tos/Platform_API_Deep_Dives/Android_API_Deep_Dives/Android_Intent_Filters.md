...
<table><tbody><tr><td><p>Open your Android browser and go to a website.<br>Select some text, then click the <strong class=" ">Share</strong> button.</p></td><td><p>You should be greeted with an Intent list that<br>looks something like this.</p></td><td><p>Select your app in the list and you will then be directed<br>to your application containing the string you highlighted.</p></td></tr><tr><td><p><img src="SelectText.png" alt="SelectText.png"></p></td><td><p><img src="ShareDialog.png" alt="ShareDialog.png"></p></td><td><p><img src="ApplicationWithText.png" alt="ApplicationWithText.png"></p></td></tr></tbody></table>
